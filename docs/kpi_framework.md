...
| **Hallucination-Free Recommendation Rate** | **100%** | **1 of 1** | 1 recommendation session | Indicates how often recommendation outputs remain fully traceable to structured data |
